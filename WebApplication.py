...
def show_team_floating():
    mehran_uri = _img_to_data_uri(TEAM_DIR / "mehran.png")
    gorka_uri = _img_to_data_uri(TEAM_DIR / "gorka.png")
    alejandro_uri = _img_to_data_uri(TEAM_DIR / "alejandro.png")
    ...
    st.markdown(
        ...
        <style>
          ...
          .team-avatar {{
            ...
            background: rgba(147,38,54,0.10);
          }}
        ...
        <div class="team-float">
          <div class="team-member">
            <div class="team-avatar-wrap">
              <img class="team-avatar" src="{mehran_uri}" alt="Mehran Sharifi" />
              <div class="team-tooltip">msharifi@unav.es</div>
            </div>
            <div class="team-name">Mehran Sharifi</div>
          </div>

          <div class="team-member">
            <div class="team-avatar-wrap">
              <img class="team-avatar" src="{gorka_uri}" alt="Gorka Sánchez Larraona" />
              <div class="team-tooltip">gsanchez@unav.es</div>
            </div>
            <div class="team-name">Gorka Sánchez Larraona</div>
          </div>

          <div class="team-member">
            <div class="team-avatar-wrap">
              <img class="team-avatar" src="{alejandro_uri}" alt="Alejandro Rivas Nieto" />
              <div class="team-tooltip">arivas@unav.es</div>
            </div>
            <div class="team-name">Alejandro Rivas Nieto</div>
          </div>
        </div>
        """,
